...
export function createSubsequenceCommand(commands) {
    ...
    const request = (args) => create.request({ ...args, kind: "subsequence" });
    return cmd({
        ...
        execute: async (args, execute) => {
            const subsequence = await execute(request(args));
...
//# sourceMappingURL=subsequences.js.map