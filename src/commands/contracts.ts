// Generated by scripts/sync-public-api.mjs from public API documents.
// Regenerate with npm run sync:public-api; review contract changes before committing.
import type { PublicApiContract } from "./endpoint.js";

export const publicApiContracts: Record<string, PublicApiContract> = {
  "salesforge GET /me": {
